...
class TreatmentsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Treatments') ? [] : ['className' => TreatmentsTable::class];
        $this->Treatments = TableRegistry::getTableLocator()->get('Treatments', $config);
    }
