...
class StaffsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Users', 'Countries', 'States', 'Departments']
        ];
    ...
    public function add()
    {
        ...
        $countries = $this->Staffs->Countries->find('list', ['limit' => 200]);
        $states = $this->Staffs->States->find('list', ['limit' => 200]);
        $departments = $this->Staffs->Departments->find('list', ['limit' => 200]);
        $this->set(compact('staff', 'users', 'countries', 'states', 'departments'));
    }
