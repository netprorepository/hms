    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info collapsed-box">
                ...
                <!-- /.box-header -->
                <div class="box-body pad">
                    <textarea name="familyhistory" class="ckeditor" rows="10" cols="80" style="visibility: hidden; display: none;"></textarea>
                </div>
            </div><!--/end box-info-->
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <div class="box-body pad">
                    <textarea name="di" class="ckeditor" rows="10" cols="80" style="visibility: hidden; display: none;"></textarea>
                </div>
            </div><!--/end box-info-->
