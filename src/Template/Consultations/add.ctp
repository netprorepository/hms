...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('List Treatmentplans'), ['controller' => 'Treatmentplans', 'action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('New Treatmentplan'), ['controller' => 'Treatmentplans', 'action' => 'add']) ?></li>
    </ul>
</nav>
